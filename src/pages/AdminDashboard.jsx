...
//   -------------------------------------------------- */
//   useEffect(() => {
//     // ✅ New enrollment (default = pending)
//     socket.on("new-enrollment", (data) => {
//       console.log("📥 NEW ENROLLMENT:", data);

//       setPendingEnrollmentCount((prev) => prev + 1);

//       playNotificationSound();
//       showToast(`New enrollment: ${data.student} (${data.course})`);
//     });
...
//     // agar future mein backend se "status-updated" emit karo
//     socket.on("enrollment-status-updated", ({ oldStatus, newStatus }) => {
//       if (oldStatus === "pending" && newStatus !== "pending") {
//         setPendingEnrollmentCount((prev) =>
//           prev > 0 ? prev - 1 : 0
//         );
//       }
//     });
...
//       socket.off("enrollment-status-updated");
//     };
//   }, []);
...
//       <motion.h1
//         className="text-4xl font-extrabold text-center text-amber-300 mb-14 tracking-wide"
...
//             className="
//               bg-gradient-to-b from-blue-900/70 to-purple-900/70
//               border border-amber-400/30 shadow-xl rounded-2xl
//               p-7 text-center flex flex-col
//             "
//           >
//             {card.icon}
...
//               to={card.link}
//               className="
//                 inline-block bg-amber-300 text-blue-900 mt-auto
//                 px-5 py-2 rounded-lg font-semibold hover:bg-purple-400
