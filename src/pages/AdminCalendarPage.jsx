...
//     e.preventDefault();
//     if (!title || !date) return alert("Title & Date are required");

//     try {
//       await axios.post("/api/calendar", { title, date, description });
...
//           <div>
//             <label className="text-sm text-blue-200">Event Title *</label>
//             <input
//               type="text"
//               className="w-full px-3 py-2 rounded bg-white/20 text-white border border-purple-300 mt-1"
//               placeholder="e.g. Tajweed Course Starts"
//               value={title}
...
//           <div>
//             <label className="text-sm text-blue-200">Event Date *</label>
//             <input
//               type="date"
//               className="w-full px-3 py-2 rounded bg-white/20 text-white border border-purple-300 mt-1"
//               value={date}
...
//           <div>
//             <label className="text-sm text-blue-200">Description (Optional)</label>
//             <textarea
//               className="w-full px-3 py-2 rounded bg-white/20 text-white border border-purple-300 mt-1"
//               rows={3}
...
//         {events.length === 0 && (
//           <p className="text-blue-200">No events added yet.</p>
//         )}
...
//             >
//               <h3 className="text-lg font-semibold text-amber-300">{ev.title}</h3>

//               <p className="text-blue-200 mt-1">
//                 <b className="text-purple-200">Date:</b> {new Date(ev.date).toDateString()}
//               </p>

//               {ev.description && (
//                 <p className="text-blue-100 mt-2">{ev.description}</p>
//               )}
